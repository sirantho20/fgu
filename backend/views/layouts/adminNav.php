		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					<li class="active">
                                            <a href="<?= (new \yii\web\UrlManager())->createAbsoluteUrl(['genset']) ?>" title="Manage Gensets"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Gensets</span></a>
					</li>
					<li>
