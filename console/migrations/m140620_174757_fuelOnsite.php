...
class m140620_174757_fuelOnsite extends \yii\db\Migration
{
    public function up()
    {
        $this->execute(
                ...
                (select sum(quantity_after_delivery_lts) from fgu_fuelling as fuelling where week(fuelling.delivery_date,1) = week(fgu.reading_date,1) and fgu.reading_date < fuelling.delivery_date) as fuel_added
